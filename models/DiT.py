...
class TimestepEmbedder(nn.Module):
    ...
    def timestep_embedding(t, dim, max_period=10000):
        ...
        args = t[:, None].float() * freqs[None] # freqs：torch.Size([1, 128])
...
class DiT(nn.Module):
    ...
    def forward(self, x, t, condition=None, mixed=True, mix_ratio=0.5, n_splits=2):
...
if __name__ == '__main__':
    x = torch.ones(8, 6, 64, 64)
    t = torch.ones(8)
    

    dit = DiT(depth=12, hidden_size=384, patch_size=2, num_heads=6,
