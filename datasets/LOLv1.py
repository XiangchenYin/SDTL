...
class LOLv1:
    ...
    def get_loaders(self):
        ...
        train_dataset = AllWeatherDataset(self.config, os.path.join(self.config.data.data_dir, 'our_485'),
                                          patch_size=self.config.data.patch_size)
        val_dataset = AllWeatherDataset(self.config, os.path.join(self.config.data.data_dir, 'eval_15'),
